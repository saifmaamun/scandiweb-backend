...
async function run() {
    try {
        ...
        const database = client.db("scandiweb");
        const productsCollaction = database.collection("products");
        // const bookedTour = database.collection("booked");

        // GET products from server to show on product page
        app.get('/products', async (req, res) => {
            const cursor = productsCollaction.find({});
...
app.get('/', (req, res) => {
    ...
    res.send('Hello World! from Scandiweb')
})
